...
class GetLoanDetailUseCase @Inject constructor(private val loanRepository: LoanRepository) {

    operator fun invoke(loanId: Int): Flow<RepositoryResult<LoanEntity>> =
        loanRepository.getLoanDetail(loanId)
}
