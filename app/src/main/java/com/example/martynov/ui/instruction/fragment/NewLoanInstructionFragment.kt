...
class NewLoanInstructionFragment : BaseInstructionFragment() {

    override val tabName = InstructionConstants.NEW_LOAN_TAB_NAME
    override val description = InstructionConstants.NEW_LOAN_INSTRUCTION
